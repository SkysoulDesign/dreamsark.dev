...
class ReviewCreateCast extends Command implements SelfHandling
{
    /**
     * @var Project
     */
    ...
    public function handle(ReviewRepositoryInterface $repository, Dispatcher $event)
    {
         ...
         * Add Cast
         */
        $expenditure = $repository->createCast($this->project->id, $this->fields->pull('position'), $this->fields->all());
