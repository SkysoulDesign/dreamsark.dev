 ...
 * http://modernizr.com/download/?-ie8compat-inlinesvg-svg-svgclippaths-mq-prefixes-shiv-teststyles !*/
!function (e, t, n) {
    function a(e, t) {
        return typeof e === t
    }
    ...
    function r() {
        ...
        for (var l in c)if (c.hasOwnProperty(l)) {
            ...
            for (r = a(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++)i = e[o], s = i.split("."), 1 === s.length ? Modernizr[s[0]] = r : (!Modernizr[s[0]] || Modernizr[s[0]] instanceof Boolean || (Modernizr[s[0]] = new Boolean(Modernizr[s[0]])), Modernizr[s[0]][s[1]] = r), u.push((r ? "" : "no-") + s.join("-"))
        }
    }
    ...
    function l(e, n, a, r) {
        var o, l, c, d, u = "modernizr", m = i("div"), p = s();
        if (parseInt(a, 10))for (; a--;)c = i("div"), c.id = r ? r[a] : u + (a + 1), m.appendChild(c);
        return o = i("style"), o.type = "text/css", o.id = "s" + u, (p.fake ? p : m).appendChild(o), p.appendChild(m), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(t.createTextNode(e)), m.id = u, p.fake && (p.style.background = "", p.style.overflow = "hidden", d = f.style.overflow, f.style.overflow = "hidden", f.appendChild(p)), l = n(m, e), p.fake ? (p.parentNode.removeChild(p), f.style.overflow = d, f.offsetHeight) : m.parentNode.removeChild(m), !!l
    }
    ...
    var u = [], f = t.documentElement, m = "svg" === f.nodeName.toLowerCase(), p = d._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];
    d._prefixes = p;
    var h = function () {
    ...
    m || !function (e, t) {
        ...
        function c(e) {
            e || (e = t);
            var a = o(e);
            return !w.shivCSS || d || a.hasCSS || (a.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || l(e, a), e
        }

        var d, u, f = "3.7.3", m = e.html5 || {}, p = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, h = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, g = "_html5shiv", v = 0, y = {};
        !function () {
            try {
    ...
    }("undefined" != typeof e ? e : this, t), Modernizr.addTest("ie8compat", !e.addEventListener && !!t.documentMode && 7 === t.documentMode), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);
    var g = {}.toString;
    ...
    }), r(), o(u), delete d.addTest, delete d.addAsyncTest;
