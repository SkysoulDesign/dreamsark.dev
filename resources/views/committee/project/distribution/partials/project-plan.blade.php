...
<table class="ui celled table">
    ...
    @include('committee.project.distribute.partials.expenditure-list', ['expenditures' => $enrollable])
    ...
    @include('committee.project.distribute.partials.expenditure-list', ['expenditures' => $expensable])
    ...
    <tr>
        ...
        <th>
            <div class="ui header">
                {{ $distribution->project->totalCollected() }}
            </div>
        </th>
    </tr>
