    ...
    <div class="row">
        ...
        <section class="small-12">
            ...
            <div class="row project">
                <div class="small-4 columns project__cover">
                    <img src="{{ asset('img/temp/cover.jpeg') }}" alt="">
                </div>
                <div class="small-8 project__header">
                    <h1>Disney: The Jungle Book</h1>
                    <div class="project__header__author">
                        <img src="{{ asset('img/avatar/male.png') }}" alt="">
                        by Microcosm Publishing
                    </div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi culpa fuga laborum molestiae officiis sunt veniam. Asperiores commodi consectetur distinctio eos ex excepturi fugiat laborum mollitia quasi, quis, quod ullam.</p>
