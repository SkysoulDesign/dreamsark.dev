...
export class Item extends AbstractComposition {
    ...
    stage(scene, camera, objects) {
        ...
        if(this.m_ConsitionManager) {
            ...
            let l_Item1Name = "/img/temp/avatar.png";
            let l_Item1Name2 = "/img/temp/avatar.png";
            let l_QuestionImage = "/img/question.png";
            let l_ResultImageFileName = "/img/temp/avatar.png";
