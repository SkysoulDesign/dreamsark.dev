@extends('translation::master')

@section('content')

    @include('translation::modals.translation-language-modal')
    @include('translation::modals.translation-group-modal')
    @include('translation::modals.translation-translation-modal')
